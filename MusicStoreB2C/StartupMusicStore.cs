...
{
    public class StartupMusicStore
    {
        private readonly Platform _platform;

        public StartupMusicStore(IHostingEnvironment hostingEnvironment)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                builder.AddUserSecrets<OrigStartup>();
            }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseOpenIdConnectAuthentication(new OpenIdConnectOptions
            {
                ...
                Authority = string.Format("https://login.microsoftonline.com/{0}/v2.0/", Configuration["AzureAD:Tenant"]),
                //ClientId = "[ClientId]",
